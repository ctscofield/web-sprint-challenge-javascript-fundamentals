...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
  ...
  /*nestedFunction can access internal because nestedFunction itself console.logs internal which is in the broader scope function. */ 
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(){
    ...
    zooAnimals.forEach(function(animals){
         newArray.push(`name: ${animals.animal_name}, scientific: ${animals.scientific_name}`);        
    });
    return newArray;
  }
  ...
  */
  ...
  function lowerCaseNames(){
    const danimals = zooAnimals.map(animal =>  animal.animal_name.toLowerCase()); 
    return danimals;
  }
  ...
  */
  ...
  function USApop(){
    ...
    const totPop = pops.reduce(accumulator);
    return totPop;
  }
